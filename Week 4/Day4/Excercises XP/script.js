...
infoAboutPerson("esther", 15, "blue")
infoAboutPerson("rafael", 19, "orange")
...
console.log("the sum of number divivsible by 23 is:", sum)
...
if( quantityInStock > 0){
    ...
    console.log("and now the new quatity of this item in stock is", stock[item])
...
function changeEnough (itemPrice, amountOfChange) {
    ...
    const sum = caculateSum(amountOfChange)
...
function hotelCost(){
    ...
    while (!isOnlyNumbers(answer)) {
        answer= prompr("how many nights would you like to stay?")
    }
